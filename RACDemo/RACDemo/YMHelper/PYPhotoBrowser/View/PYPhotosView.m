...
- (UIButton *)addImageButton
{
    if (!_addImageButton) {
        ...
        [addImage setImage:PYAddImage forState:UIControlStateNormal];
        [addImage setBackgroundColor:[UIColor colorWithRed:238/255.0 green:238/255.0 blue:238/255.0 alpha:1]];
